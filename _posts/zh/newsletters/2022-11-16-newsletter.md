...
- **<!--trezor-suite-adds-coin-control-features-->****Trezor Suite 添加选币控制功能：**
  在[最近的博文][trezor coin control]中，Trezor 宣布Trezor Suite 现在支持[选币控制][topic coin selection]功能。

- **<!--strike-adds-taproot-send-support-->****Strike 添加了 taproot 发送支持：**
  Strike 的钱包现在允许发送到 [bech32m][topic bech32] 地址。

- **<!--kollider-exchange-launches-with-lightning-support-->****Kollider 交易所上线，支持闪电网络：**
