...
- [BOLTs #1001][] 建议，节点在广播了更改其支付转发策略后，应继续接受使用旧策略接收付款约 10 分钟。这可以防止由于发送方不知道最近的策略更新而导致的付款失败。有关采用此类规则的实现示例，请参见 [Newsletter #169][news169 cln4806]。
...
[news169 cln4806]: /zh/newsletters/2021/10/06/#c-lightning-4806
...
[news201 package relay]: /zh/newsletters/2022/05/25/#package-relay-proposal
